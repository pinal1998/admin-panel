...
if($_POST)
{
    ...
    $query=mysqli_query($connection,"insert into tbl_user(st_name,st_password,
        st_email,st_contactno,st_address,is_active)values('{$name}','{$password}','{$email}','{$contactno}','{$address}','{$isactive}')") or die (mysqli_error($connection));
   if ($query){
                            ...
                            <div class="form" >
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="" novalidate="novalidate">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="st_name" name="st_name" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="st_password" class="control-label col-lg-3">Password</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="st_password" name="st_password" type="password">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="st_contactno" name="st_contactno" type="contactno">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="st_address" class="control-label col-lg-3">Address</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="st_address" name="st_address" type="address">
                                        </div>
                                    </div>
